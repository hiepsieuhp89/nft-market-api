...
export type ActionRunResponse = ActionRunBase & (ActionRunPendingData | ActionRunErrorData | ActionRunSuccessData | ActionRunThrottledData);
...
//# sourceMappingURL=action-run.res.d.ts.map