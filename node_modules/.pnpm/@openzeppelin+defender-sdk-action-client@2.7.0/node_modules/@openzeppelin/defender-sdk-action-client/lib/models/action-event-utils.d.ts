 ...
 */
export type MonitorConditionSummary = TransactionConditionSummary | InternalFunctionConditionSummary | FunctionConditionSummary | EventConditionSummary;
/**
...
export declare function isTxAlert(alert: TxAlert): alert is TxAlert;
export declare function isBlockAlert(alert: BlockAlert): alert is BlockAlert;
...
export {};
//# sourceMappingURL=action-event-utils.d.ts.map