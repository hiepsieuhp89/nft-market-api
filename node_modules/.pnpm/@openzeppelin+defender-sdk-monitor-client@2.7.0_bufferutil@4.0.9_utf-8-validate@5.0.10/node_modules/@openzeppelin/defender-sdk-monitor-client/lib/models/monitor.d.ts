...
export interface ExternalCreateBlockMonitorRequest extends ExternalBaseCreateMonitorRequest {
    network: Network;
    confirmLevel?: MonitorConfirmation;
    addresses: string[];
    abi?: string;
...
export interface ExternalUpdateBlockMonitorRequest extends Omit<ExternalCreateBlockMonitorRequest, 'network' | 'addresses' | 'name' | 'notificationChannels'> {
    monitorId: string;
    network?: Network;
    addresses?: string[];
    name?: string;
