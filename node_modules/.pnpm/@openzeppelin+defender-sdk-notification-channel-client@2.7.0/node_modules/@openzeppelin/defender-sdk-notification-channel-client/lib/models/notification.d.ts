...
export type SaveNotificationRequest = SaveNotificationSlackRequest | SaveNotificationEmailRequest | SaveNotificationDiscordRequest | SaveNotificationTelegramBotRequest | SaveNotificationPagerDutyRequest | SaveNotificationDatadogRequest | SaveNotificationOpsgenieRequest;
export type NotificationType = 'slack' | 'email' | 'discord' | 'telegram' | 'datadog' | 'webhook' | 'opsgenie' | 'pager-duty';
